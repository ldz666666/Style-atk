...
#change to 2d tensor
resize = nn.Upsample(size=(300, 300), mode='bilinear').cuda()
model = EfficientNet.from_name('efficientnet-b3')
model._fc = nn.Linear(1536, 1)

model.load_state_dict(
    torch.load("/hd1/fanhongxing/fake_detect/out/atack_efficient_style_1101/1_efficient.ckpt"))
